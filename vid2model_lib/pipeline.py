...
def _skeleton_profile_scale_group(joint_name: str) -> str:
    ...
    if joint_name.startswith("rightUpperArm") or joint_name.startswith("rightLowerArm"):
        return "right_arm"
    if joint_name.startswith("leftHand") or joint_name.startswith("leftThumb") or joint_name.startswith("leftIndex") or joint_name.startswith("leftMiddle") or joint_name.startswith("leftRing") or joint_name.startswith("leftLittle"):
        return "left_hand"
    if joint_name.startswith("rightHand") or joint_name.startswith("rightThumb") or joint_name.startswith("rightIndex") or joint_name.startswith("rightMiddle") or joint_name.startswith("rightRing") or joint_name.startswith("rightLittle"):
        return "right_hand"
    if joint_name.startswith("leftUpperLeg") or joint_name.startswith("leftLowerLeg") or joint_name.startswith("leftFoot") or joint_name.startswith("leftToes"):
        return "left_leg"
    if joint_name.startswith("rightUpperLeg") or joint_name.startswith("rightLowerLeg") or joint_name.startswith("rightFoot") or joint_name.startswith("rightToes"):
        return "right_leg"
    return "global"
...
def apply_skeleton_profile_to_rest_offsets(
    ...
    stats = {
        ...
        "group_scale_ratios": {
            key: float(value)
            for key, value in sorted(resolved_group_scale_ratios.items())
        },
